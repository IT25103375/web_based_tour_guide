...
import { destinations as mockDestinations, tourPackages } from "../data/mockData";
...
export default function DestinationSearch() {
  ...
  // Load real destinations from the backend; fall back to mock data on
      ...
      if (Array.isArray(data) && data.length > 0) {
        setDestinations(
            data.map((dest: any, i: number) => ({
              ...
              description: mockDestinations[i % mockDestinations.length].description,
              highlights: mockDestinations[i % mockDestinations.length].highlights,
              image: mockDestinations[i % mockDestinations.length].image,
              climate: mockDestinations[i % mockDestinations.length].climate,
              bestTime: mockDestinations[i % mockDestinations.length].bestTime,
            }))
        );
      }
    });
